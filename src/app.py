...
activities = {
    ...
    "Painting Workshop": {
        "description": "Explore painting techniques with acrylics, watercolor, and sketching",
    ...
    "Science Olympiad": {
        "description": "Prepare for science competitions through experiments and problem-solving",
